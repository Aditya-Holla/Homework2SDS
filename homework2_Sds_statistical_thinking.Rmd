...
|                                                                             |
| [Link to Code](https://github.com/Aditya-Holla/Homework2SDS/blob/main/homework2_Sds_statistical_thinking.Rmd) |
+-----------------------------------------------------------------------------+
...
This is a distribution of evaluation scores based off of the professors gender. Both the graphs are slightly skewed left. Both genders have roughly a similar average evaluation score around 4.
...
This line graph illustrates the average hourly bike rentals across different hours of the day, separated by working days and non-working days. Rentals tend to peak during commuting hours on working days, while non-working days show a more varied pattern with increased rentals during the middle of the day. Working days have two peaks while non working days have 1. This graph shows time by hour and average number of bikes split by weekends and weekdays.
...
This figure shows the average number of bike rentals at 9:00 AM across different weather conditions. Clear or partly cloudy weather sees the highest average ridership, followed by misty/cloudy conditions for both weekdays and weekends but mainly seen in weekdays. As weather conditions worsen to rain or snow, there is a sharp decrease in bike rentals, suggesting weather has a significant impact on ridership patterns. This graph shows weather situation and the corresponding average ride share by the number of bikes.
...
This figure shows the average number of UT bus boarding throughout the day, separated by day of the week and month. The peak boarding hours remain broadly similar across weekdays, with major peaks occurring around the 15th hour of the day. Weekends had significantly lower ridership, with no obvious peaks. The reason for low ridership on Mondays in September may be due to Labor Day and Wednesday, Thursday, and Friday in November because of Thanksgiving break.
...
In this graph, you can see the 19 artists who have had at least 30 songs on the billboard for over 10 weeks. The graph displays how many songs each of these 19 artists have. In this graph, we can see that Elton John leads the artists with over 50 songs that are ten week hits.
